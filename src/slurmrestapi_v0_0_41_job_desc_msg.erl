-module(slurmrestapi_v0_0_41_job_desc_msg).

-export([encode/1]).

-export_type([slurmrestapi_v0_0_41_job_desc_msg/0]).

-type slurmrestapi_v0_0_41_job_desc_msg() ::
    #{ 'account' => binary(),
       ...
       'begin_time' => slurmrestapi_v0_0_41_job_desc_msg_begin_time:slurmrestapi_v0_0_41_job_desc_msg_begin_time(),
       'flags' => list(),
       'burst_buffer' => binary(),
       'clusters' => binary(),
       ...
       'crontab' => slurmrestapi_v0_0_41_job_desc_msg_crontab:slurmrestapi_v0_0_41_job_desc_msg_crontab(),
       'deadline' => integer(),
       'delay_boot' => integer(),
       'dependency' => binary(),
       'end_time' => integer(),
       'environment' => list(),
       'rlimits' => slurmrestapi_v0_0_41_job_desc_msg_rlimits:slurmrestapi_v0_0_41_job_desc_msg_rlimits(),
       'excluded_nodes' => list(),
       'extra' => binary(),
       'constraints' => binary(),
       'group_id' => binary(),
       ...
       'overcommit' => boolean(),
       'partition' => binary(),
       'distribution_plane_size' => slurmrestapi_v0_0_41_job_desc_msg_distribution_plane_size:slurmrestapi_v0_0_41_job_desc_msg_distribution_plane_size(),
       'power_flags' => list(),
       'prefer' => binary(),
       'hold' => boolean(),
       ...
       'kill_warning_delay' => slurmrestapi_v0_0_41_job_desc_msg_kill_warning_delay:slurmrestapi_v0_0_41_job_desc_msg_kill_warning_delay(),
       ...
       'memory_per_node' => slurmrestapi_v0_0_41_job_desc_msg_memory_per_cpu:slurmrestapi_v0_0_41_job_desc_msg_memory_per_cpu(),
       'temporary_disk_per_node' => integer(),
       'selinux_context' => binary(),
       'required_switches' => slurmrestapi_v0_0_41_job_desc_msg_required_switches:slurmrestapi_v0_0_41_job_desc_msg_required_switches(),
       'segment_size' => slurmrestapi_v0_0_41_job_desc_msg_segment_size:slurmrestapi_v0_0_41_job_desc_msg_segment_size(),
