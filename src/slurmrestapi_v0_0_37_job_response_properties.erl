-module(slurmrestapi_v0_0_37_job_response_properties).

-export([encode/1]).

-export_type([slurmrestapi_v0_0_37_job_response_properties/0]).

-type slurmrestapi_v0_0_37_job_response_properties() ::
    #{ 'account' => binary(),
       'accrue_time' => integer(),
       'admin_comment' => binary(),
       'array_job_id' => binary(),
       'array_task_id' => binary(),
       'array_max_tasks' => binary(),
       'array_task_string' => binary(),
       'association_id' => binary(),
       ...
       'group_id' => binary(),
       'job_id' => binary(),
       'job_resources' => slurmrestapi_v0_0_37_job_resources:slurmrestapi_v0_0_37_job_resources(),
       'job_state' => binary(),
       'last_sched_evaluation' => binary(),
       'licenses' => binary(),
       'max_cpus' => binary(),
       'max_nodes' => binary(),
       'mcs_label' => binary(),
       ...
       'nodes' => binary(),
       'nice' => binary(),
       'tasks_per_core' => binary(),
       'tasks_per_socket' => binary(),
       'tasks_per_board' => binary(),
       'cpus' => binary(),
       'node_count' => binary(),
       'tasks' => binary(),
       'het_job_id' => binary(),
       'het_job_id_set' => binary(),
       'het_job_offset' => binary(),
       'partition' => binary(),
       'memory_per_node' => binary(),
       'memory_per_cpu' => binary(),
       'minimum_cpus_per_node' => binary(),
       'minimum_tmp_disk_per_node' => binary(),
       ...
       'shared' => binary(),
       'show_flags' => list(),
       'sockets_per_board' => binary(),
       'sockets_per_node' => binary(),
       'start_time' => integer(),
