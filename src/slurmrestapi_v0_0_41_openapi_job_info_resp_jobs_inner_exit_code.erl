-module(slurmrestapi_v0_0_41_openapi_job_info_resp_jobs_inner_exit_code).

-export([encode/1]).

-export_type([slurmrestapi_v0_0_41_openapi_job_info_resp_jobs_inner_exit_code/0]).

-type slurmrestapi_v0_0_41_openapi_job_info_resp_jobs_inner_exit_code() ::
    #{ 'status' => list(),
