-module(slurmrestapi_v0_0_39_job_desc_msg).

-export([encode/1]).

-export_type([slurmrestapi_v0_0_39_job_desc_msg/0]).

-type slurmrestapi_v0_0_39_job_desc_msg() ::
    #{ 'account' => binary(),
       ...
       'crontab' => slurmrestapi_v0_0_39_cron_entry:slurmrestapi_v0_0_39_cron_entry(),
       'deadline' => integer(),
       'delay_boot' => integer(),
       'dependency' => binary(),
       'end_time' => integer(),
       ...
       'kill_warning_delay' => slurmrestapi_v0_0_39_uint16_no_val:slurmrestapi_v0_0_39_uint16_no_val(),
       ...
       'required_switches' => slurmrestapi_v0_0_39_uint32_no_val:slurmrestapi_v0_0_39_uint32_no_val(),
